...
> Lineage: 2 outbound / 5 inbound · ✅ No engine drift detected · Index coverage: ready · PII flags: 2 · Changelog: fresh (18 d)
...
| Pkg folder | [packages\payments](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\payments) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package payments -Apply
