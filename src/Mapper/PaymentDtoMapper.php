...
namespace BlackCat\Database\Packages\Payments\Mapper;

use BlackCat\Database\Packages\Payments\Dto\PaymentDto;
use BlackCat\Database\Packages\Payments\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO PaymentDto:
 ...
 */
final class PaymentDtoMapper
{
    /** @var array<string,string> Column -> DTO property */
    private const COL_TO_PROP = [ 'id' => 'id', 'tenant_id' => 'tenantId', 'order_id' => 'orderId', 'gateway' => 'gateway', 'transaction_id' => 'transactionId', 'provider_event_id' => 'providerEventId', 'status' => 'status', 'amount' => 'amount', 'currency' => 'currency', 'details' => 'details', 'created_at' => 'createdAt', 'updated_at' => 'updatedAt', 'version' => 'version' ];

    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'tenant_id', 'order_id', 'version' ];
    /** @var string[] */
    private const FLOAT_COLS  = [ 'amount' ];
    /** @var string[] */
    private const JSON_COLS   = [ 'details' ];
    /** @var string[] */
     ...
     * @return PaymentDto
     */
    public static function fromRow(array $row): PaymentDto
    {
        /** @var PaymentDto */
    ...
    public static function fromRowOrNull(?array $row): ?PaymentDto
    {
     ...
     */
    public static function toRow(PaymentDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(PaymentDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(PaymentDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(PaymentDto $dto): array
    {
        $row = self::toRow($dto);
