...
final class PaymentDtoMapper
{
    ...
    private const COL_TO_PROP = [ 'tenant_id' => 'tenantId', 'order_id' => 'orderId', 'transaction_id' => 'transactionId', 'provider_event_id' => 'providerEventId', 'created_at' => 'createdAt', 'updated_at' => 'updatedAt' ];
