...
final class PaymentDtoMapper
{
    ...
    private const COL_TO_PROP = [ 'order_id' => 'orderId', 'transaction_id' => 'transactionId', 'provider_event_id' => 'providerEventId', 'created_at' => 'createdAt', 'updated_at' => 'updatedAt' ];
    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'order_id' ];
    /** @var string[] */
    ...
    /** @var string[] */
    private const NULLABLE    = [ 'id', 'order_id', 'transaction_id', 'provider_event_id', 'details' ];
