...
final class PaymentRepository implements RepoContract {
    ...
    public function insert(array $row): void {
        ...
        $tblEsc  = $isMysql ? '`payments`' : '"payments"';
     ...
     * [ 'transaction_id' ] = unikátní klíče (sloupce) pro konflikty,
     * [ 'order_id', 'gateway', 'provider_event_id', 'status', 'amount', 'currency', 'details', 'updated_at' ] = které sloupce aktualizovat.
     */
    public function upsert(array $row): void {
        ...
        $keys = [ 'transaction_id' ];
        $upd  = [ 'order_id', 'gateway', 'provider_event_id', 'status', 'amount', 'currency', 'details', 'updated_at' ];
