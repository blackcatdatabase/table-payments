 ...
 * - whitelist filtrů: [ 'id', 'order_id', 'gateway', 'transaction_id', 'provider_event_id', 'status', 'amount', 'currency', 'details', 'created_at', 'updated_at', 'version' ]
 * - whitelist LIKE:   [ 'gateway', 'transaction_id', 'provider_event_id', 'status', 'currency' ]
 * Podporované tvary:
...
final class Criteria {
    ...
    public function toSql(bool $viewMode = false): array {
        ...
        $allowed = array_fill_keys([ 'id', 'order_id', 'gateway', 'transaction_id', 'provider_event_id', 'status', 'amount', 'currency', 'details', 'created_at', 'updated_at', 'version' ], true);
        ...
        $order = null;
        if ($this->sort) {
            $safeCols = array_fill_keys([ 'id', 'order_id', 'gateway', 'transaction_id', 'provider_event_id', 'status', 'amount', 'currency', 'details', 'created_at', 'updated_at', 'version' ], true);
            $parts = [];
