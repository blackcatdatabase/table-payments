...
final class Definitions {
    ...
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'order_id', 'gateway', 'transaction_id', 'provider_event_id', 'status', 'amount', 'currency', 'details', 'created_at', 'updated_at', 'version' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'transaction_id' ], [ 'constraint' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'order_id', 'version' ]; }
