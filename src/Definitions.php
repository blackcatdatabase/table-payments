...
final class Definitions {
    ...
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'tenant_id', 'order_id', 'gateway', 'transaction_id', 'provider_event_id', 'status', 'amount', 'currency', 'details', 'created_at', 'updated_at', 'version' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'tenant_id', 'transaction_id' ], [ 'tenant_id', 'id' ], [ 'id' ] ]; }

    /** @return string[] JSON columns for casts/operations */
    public static function jsonColumns(): array { return [ 'details' ]; }

    /** @return string[] List of numeric columns (generator heuristic; no runtime DB queries). */
    public static function intColumns(): array { return [ 'id', 'tenant_id', 'order_id', 'version' ]; }
