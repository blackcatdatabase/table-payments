...
use BlackCat\Database\Packages\Payments\Repository\PaymentRepository as GeneratedRepository;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof PaymentRepositoryInterface) {
            ...
            throw new \InvalidArgumentException('Expected PaymentRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\Payments\Dto\PaymentDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\Payments\Dto\PaymentDto|null { return $this->repo->getById($id, $asDto); }
